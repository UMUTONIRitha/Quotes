...
export class QuoteComponent implements OnInit {
  quotes:Quote[] = [
   ...
   new Quote(2,'The way to get started is to quit talking and begin doing.','Walt Disney',new Date(2015,5,24)),
    new Quote(3,'If life were predictable it would cease to be life, and be without flavor.','Eleanor Roosevelt',new Date(2020,3,14)),
